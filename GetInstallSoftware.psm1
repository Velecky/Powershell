...
Function Get-InstalledSoftware
{
	...
	Process
	{
		ForEach($Computer in $Name)
		{
			...
			$MasterKeys = ($MasterKeys | Where {$_.Name -ne $Null -AND $_.SystemComponent -ne "1" -AND $_.ParentKeyName -eq $Null} | select ComputerName,Name,Version,InstallDate,UninstallCommand | sort Name)
			$MasterKeys
		}
	}
	End
